...
Handlebars.registerPartial("bio", Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
...
function program2(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, depth0.bio, {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { return stack1; }
  else { return ''; }
  }));

Handlebars.registerPartial("duration", Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
function program1(depth0,data) {
  ...
  stack2 = helpers['if'].call(depth0, ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.days), {hash:{},inverse:self.noop,fn:self.program(2, program2, data),data:data});
  ...
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n        ";
  stack2 = helpers['if'].call(depth0, ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.hours), {hash:{},inverse:self.noop,fn:self.program(6, program6, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n        ";
  options = {hash:{},inverse:self.noop,fn:self.program(4, program4, data),data:data};
  ...
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n        ";
  stack2 = helpers['if'].call(depth0, ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.minutes), {hash:{},inverse:self.noop,fn:self.program(8, program8, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n        ";
  options = {hash:{},inverse:self.noop,fn:self.program(4, program4, data),data:data};
  ...
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n        ";
  stack2 = helpers['if'].call(depth0, ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.seconds), {hash:{},inverse:self.noop,fn:self.program(10, program10, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n    </ul>\n";
  return buffer;
  }
...
function program6(depth0,data) {
  ...
  buffer += "<div class=\"icon pull-left\">\n    ";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<ul class=\"statistics pull-left\">\n    <li class=\"followings\">\n        <a href=\"#followings/";
...
function program6(depth0,data) {
  ...
  var buffer = "", stack1, stack2, options;
  buffer += "\n    ";
  options = {hash:{},inverse:self.program(12, program12, data),fn:self.program(7, program7, data),data:data};
...
Handlebars.registerPartial("username", Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, stack2, options, functionType="function", escapeExpression=this.escapeExpression, self=this, helperMissing=helpers.helperMissing;
...
function program3(depth0,data) {
  ...
  buffer += "<p class=\"username username-item pull-left\">\n    ";
  options = {hash:{},inverse:self.program(3, program3, data),fn:self.program(1, program1, data),data:data};
  stack2 = ((stack1 = helpers.ifSystemUser || depth0.ifSystemUser),stack1 ? stack1.call(depth0, ((stack1 = depth0.author),stack1 == null || stack1 === false ? stack1 : stack1.pid), options) : helperMissing.call(depth0, "ifSystemUser", ((stack1 = depth0.author),stack1 == null || stack1 === false ? stack1 : stack1.pid), options));
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n</p>";
...
Handlebars.registerPartial("via", Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var stack1, functionType="function", escapeExpression=this.escapeExpression, self=this;
...
function program1(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, depth0.via, {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { return stack1; }
  else { return ''; }
  }));
...
function program5(depth0,data) {
  ...
  stack1 = self.invokePartial(partials.bio, 'bio', depth0, helpers, partials, data);
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n";
...
function program17(depth0,data) {
  ...
  stack2 = helpers['if'].call(depth0, ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.days), {hash:{},inverse:self.noop,fn:self.program(18, program18, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n                    ";
  ...
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n                    ";
  stack2 = helpers['if'].call(depth0, ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.hours), {hash:{},inverse:self.noop,fn:self.program(22, program22, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n                    ";
  options = {hash:{},inverse:self.noop,fn:self.program(20, program20, data),data:data};
  stack2 = ((stack1 = helpers.and || depth0.and),stack1 ? stack1.call(depth0, ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.hours), ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.minutes), options) : helperMissing.call(depth0, "and", ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.hours), ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.minutes), options));
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n                    ";
  stack2 = helpers['if'].call(depth0, ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.minutes), {hash:{},inverse:self.noop,fn:self.program(24, program24, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n                    ";
  options = {hash:{},inverse:self.noop,fn:self.program(20, program20, data),data:data};
  stack2 = ((stack1 = helpers.and || depth0.and),stack1 ? stack1.call(depth0, ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.minutes), ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.seconds), options) : helperMissing.call(depth0, "and", ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.minutes), ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.seconds), options));
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n\n                    ";
  stack2 = helpers['if'].call(depth0, ((stack1 = depth0.duration),stack1 == null || stack1 === false ? stack1 : stack1.seconds), {hash:{},inverse:self.noop,fn:self.program(26, program26, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n                </ul>\n            ";
  return buffer;
  }
...
function program26(depth0,data) {
  ...
  buffer += escapeExpression(stack2)
    + "\">\n    </div>\n\n\n    <div class=\"field item-add-image\">\n        <div class=\"item-add-image-placeholder\">\n            <img class=\"item-add-loading\" src=\"/-assets/images/loading-image.gif\" height=\"16\" width=\"16\" />\n            <ul class=\"item-add-image-list\">\n                <li class=\"item-add-image-list-empty\">No images</li>\n                <li class=\"item-add-image-list-item item-add-image-best item-add-image-list-current\"></li>\n            </ul>\n\n            <ul class=\"item-add-image-controls\">\n                <li class=\"item-add-image-controls-next\">\n                    <i class=\"icon-circle-arrow-right\"></i>\n                </li>\n                <li class=\"item-add-image-controls-prev\">\n                    <i class=\"icon-circle-arrow-left\"></i>\n                </li>\n            </ul>\n\n            ";
  stack2 = helpers['if'].call(depth0, depth0.duration, {hash:{},inverse:self.noop,fn:self.program(17, program17, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n        </div>\n    </div>\n\n    <div class=\"field item-add-has-event\">\n        <label for=\"has-event\">\n            Add event or schedule date:\n            <input type=\"checkbox\" name=\"has-event\" id=\"has-event\">\n        </label>\n    </div>\n\n    <div class=\"field item-add-event\">\n        <label for=\"event\">Event Date</label>\n        <input type=\"date\" placeholder=\"YYYY-MM-DD\" min=\"1900-00-00\" name=\"event\" value=\"";
...
function program10(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n";
  stack1 = self.invokePartial(partials.icon, 'icon', depth0, helpers, partials, data);
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n";
  stack1 = self.invokePartial(partials.username, 'username', depth0, helpers, partials, data);
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n";
  stack1 = self.invokePartial(partials.title, 'title', depth0, helpers, partials, data);
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n";
  stack1 = self.invokePartial(partials.duration, 'duration', depth0, helpers, partials, data);
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n";
  stack1 = self.invokePartial(partials.via, 'via', depth0, helpers, partials, data);
  if(stack1 || stack1 === 0) { buffer += stack1; }
